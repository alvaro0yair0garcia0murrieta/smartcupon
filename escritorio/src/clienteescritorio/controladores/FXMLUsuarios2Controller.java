...
public class FXMLUsuarios2Controller implements Initializable, IRespuesta {
    ...
    private void irAModificar(ActionEvent event) {
        ...
        if (posicion != -1) {
            ...
            Utilidades.alerta("Selección requerida", "Debes seleccionar un usuario para su edición", Alert.AlertType.WARNING);
        }
    }
    ...
    private void eliminar(ActionEvent event) {
        ...
        if (seleccion != null) {
            ...
            Utilidades.alerta("Selección requerida", "Debes seleccionar un usuario para su eliminación", Alert.AlertType.WARNING);
        }
    }
    ...
    private void inicializarBusqueda() {
        if (usuarios != null) {
            FilteredList<Usuario> filtro = new FilteredList<>(usuarios, p -> true);
            ...
            busquedaField.textProperty().addListener(new ChangeListener<String>() {
                ...
                public void changed(ObservableValue<? extends String> observable, String oldValue, String newValue) {
                    ...
                    filtro.setPredicate(itemBusqueda -> {
                        ...
                        return itemBusqueda.getNombre().toLowerCase().contains(lowerFilter);
                    });
                }
            });
