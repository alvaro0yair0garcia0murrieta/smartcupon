    ...
    private void irAActualizar(ActionEvent event) {
        ...
        if(posicion != -1){
            ...
            Utilidades.alerta("Selección requerida", 
                    "Debes seleccionar una sucursal para su edición", 
   ...
   LongitudC.setCellValueFactory(new PropertyValueFactory("longitud"));    }
    ...
    private void llenarTabla(){
     ...
     private void inicializarBusqueda(){
        if(sucursales != null){
            FilteredList<Sucursal> filtro = 
                    new FilteredList<>(sucursales, p -> true);
            ...
            busqueadaField.textProperty().addListener(new ChangeListener<String>(){
                ...
                public void changed(ObservableValue<? extends String> observable, 
                    ...
                    filtro.setPredicate(itemBusqueda -> {
                        ...
                        if(itemBusqueda.getNumero().toLowerCase().contains(lowerFilter)){
                            return true;
                        }
