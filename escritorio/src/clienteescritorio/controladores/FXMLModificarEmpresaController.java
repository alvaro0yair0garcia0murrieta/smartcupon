  ...
  private String estatusString;
   private IRespuesta observador;
    ...
    obtenerImagenServicio();
       ...
       private void cargarFotografiaServidor(File imagen){
        try {
            ...
            Mensaje msj = EmpresaDAO.subirFotografiaEmpresa(
                                             imgBytes,empresa.getIdEmpresa());
            if(!msj.getError()){
    ...
    private void obtenerImagenServicio(){
        Empresa empresaFoto = 
                EmpresaDAO.obtenerFotografia(empresa.getIdEmpresa());
        if(empresaFoto != null && empresaFoto.getLogoBase64() != null 
                && !empresaFoto.getLogoBase64().isEmpty()){
