...
public class FXMLEmpresaController implements Initializable, IRespuesta {
    ...
    private void irAModificar(ActionEvent event) {
        ...
        if (posicion != -1) {
            ...
            Utilidades.alerta("Selección requerida", "Debes seleccionar una empresa para su edición", Alert.AlertType.WARNING);
        }
    ...
    private void inicializarBusqueda() {
        if (empresas != null) {
            FilteredList<Empresa> filtro = new FilteredList<>(empresas, p -> true);
            ...
            busquedaField.textProperty().addListener(new ChangeListener<String>() {
                ...
                public void changed(ObservableValue<? extends String> observable, String oldValue, String newValue) {
                    ...
                    filtro.setPredicate(itemBusqueda -> {
                        ...
                        return itemBusqueda.getRepresentante().toLowerCase().contains(lowerFilter);
                    });
                }
            });
